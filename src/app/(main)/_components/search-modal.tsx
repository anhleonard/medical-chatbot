...
export default function SearchModal() {
    ...
    return (
        <Popover>
            ...
            <PopoverContent className="z-50 mt-1 ml-[220px] text-sm w-[400px] bg-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] text-grey-c900 rounded-xl border-primary-c900/20 border-[1px] overflow-hidden
